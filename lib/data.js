...
export const IMG_META = {
  ...
  "/DSC06965_Original.jpg": { w: 5990, h: 3993 },
  ...
  "/drummer.jpg":   { w: 2048, h: 1365 },
  "/singer.jpg":    { w: 1365, h: 2048 },
};
...
export const WORKS = [
  ...
  },
  {
    ...
    client: "Private Commission",
    year: "2026",
    discipline: "Vocal · Stills",
    cover: "/singer.jpg",
    description:
      "A single voice held in a single beam — the stage erased to pure black above, the patternwork of the sarong glowing below, the mic lifted into the only light in the room.",
  },
  {
    id: "04",
    title: "Low Light",
  ...
  },
  {
    ...
    client: "Private Commission",
    year: "2026",
    discipline: "Rhythm · Stills",
    cover: "/drummer.jpg",
    description:
      "The drummer caught between two hits — the SUDOKU kit lit from inside, the rest of the stage receding into pure black while a bassist hovers at the edge of the frame.",
  },
  {
    id: "06",
    title: "Blue Hour",
